...
import { useGetAiTranslationDetailsQuery, useUpdateAiTranslationMutation } from "@/redux/features/translation/translation.api"
...
const EditAiTranslation = () => {
    ...
    const onSubmit = async(formData: TranslationFormData) => {
        ...
        try {
            const result = await updateAiTranslation({
                id: aiTranslationId,
                data: {
                    ...formData,
...
export default EditAiTranslation