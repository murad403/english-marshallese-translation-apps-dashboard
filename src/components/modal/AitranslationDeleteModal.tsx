...
import { useDeleteAiTranslationMutation } from '@/redux/features/translation/translation.api';

const AiTranslationDeleteModal = ({ id }: { id: number }) => {
    const [deleteAiTranslation, { isLoading }] = useDeleteAiTranslationMutation();
    const handleDelete = async (id: number) => {
        try {
            const result = await deleteAiTranslation(id).unwrap();
...
export default AiTranslationDeleteModal
