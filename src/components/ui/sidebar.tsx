  ...
  function SidebarTrigger({
    ...
    return (
      ...
      >
        ...
        {/* <MdOutlineMenuOpen className="text-[35px] text-title"/> */}
  ...
  function SidebarMenu({ className, ...props }: React.ComponentProps<"ul">) {
    return (
      <ul
        ...
        data-sidebar="menu"
        className={cn("flex w-full min-w-0 flex-col gap-3 mt-20", className)}
        {...props}
      />
    )
  }
